    ...
    <ul class="navbar-nav ml-auto">
     ...
     <!-- Dropdown - Messages -->
      ...
      <a href="#" class="btn btn-success btn-icon-split m-3 ">
        ...
        <span class='text'><div class="btn-up-barang">Upload barang</div> </span>
      </a>

      <!-- end upload produk button -->
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">
          <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $mitra['name']; ?></span>
          <img class="img-profile rounded-circle" src="<?= base_url('assets/img/photo-profile/'.$mitra['photo']); ?>">
        </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn btn-success" href="<?= base_url('dashboard/logout'); ?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
